...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('businessname', models.CharField(db_column='BusinessName', max_length=100)),
                ...
                ('websiteurl', models.CharField(blank=True, db_column='WebsiteURL', max_length=255, null=True)),
            ],
            options={
                'db_table': 'Business',
                'managed': False,
